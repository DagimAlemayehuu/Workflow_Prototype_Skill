...
Learn how to use workflow-expert-skills effectively with an AI Agent.
...
AI Agent: Uses search_nodes({query: "email"})
...
AI Agent: Webhook data is under .body!
Fix: {{$json.body.name}}
```
...
AI Agent: Binary operators (equals, contains) should NOT have singleValue.
...
AI Agent: AI Agent Workflow Pattern:
...
- **Issues**: https://github.com/[your-username]/workflow-expert-skills/issues
- **Discussions**: https://github.com/[your-username]/workflow-expert-skills/discussions

---

**Ready to build amazing n8n workflows with an AI Agent? Start asking questions!** 🚀
