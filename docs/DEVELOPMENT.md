...
Guidelines for contributing to workflow-expert-skills and developing new skills.
...
```
n8n-skills/
├── skills/                    # Skill implementations (categorized)
│   ├── n8n/
...
**Process**:
1. Run evaluation scenarios with the AI Agent
